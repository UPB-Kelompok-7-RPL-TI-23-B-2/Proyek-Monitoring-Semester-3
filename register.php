          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                ...
                ?>
                <form action="proses/register_proses.php" method="POST" role="form" class="text-start">
                  ...
                  <div class="input-group input-group-outline mb-3">
                    <label for="konfirmasi_password" class="form-label"></label>
                    <input type="text" name="konfirmasi_password" class="form-control" placeholder="Konfirmasi Password" required>
                </div>
                ...
                <div class="text-center">
                  <label class="mb-0 text-center">Sudah Punya Akun? <a href="login.php">Log in</a></label>
                </div>
                </form>
              </div>
            </div>
